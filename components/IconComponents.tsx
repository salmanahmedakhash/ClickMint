...
export const ClipboardDocumentCheckIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 0 1 9 9v.375M10.125 2.25c-.621 0-1.125.504-1.125 1.125v3.375c0 .621.504 1.125 1.125 1.125h1.5c.621 0 1.125-.504 1.125-1.125v-3.375c0-.621-.504-1.125-1.125-1.125h-1.5Zm-6.375 18v-17.25a1.125 1.125 0 0 1 1.125-1.125h12.75c.621 0 1.125.504 1.125 1.125v9M15.188 18.312a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
    </svg>
);
...
export const UserGroupIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.51.056 1.02.086 1.5.086s.99-.03 1.5-.086m-7.5 0a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0Zm3.75 4.625a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Zm-3.75-8.625a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0Z" />
    </svg>
);
...
export const RocketLaunchIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a17.96 17.96 0 0 1-1.25.13m-5.84 0a17.96 17.96 0 0 0-1.25-.13m-2.92-1.11a17.96 17.96 0 0 1 1.25-.12m5.84 0a17.96 17.96 0 0 0 1.25.12M9 12a8.96 8.96 0 0 0-2.316.31M15 12a8.96 8.96 0 0 1-2.316.31M12 12a8.96 8.96 0 0 0 0 .62m0 0a8.96 8.96 0 0 1 0 .62M3 7.5l2.625 2.625M3 16.5l2.625-2.625M21 7.5l-2.625 2.625M21 16.5l-2.625-2.625M12 3v2.25m0 16.5V21" />
    </svg>
);
...
export const ExternalLinkIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-4.5 0V6.375c0-.621.504-1.125 1.125-1.125h2.25M13.5 12l4.5-4.5" />
    </svg>
);

export const WhatsAppIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.894 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.886-.001 2.269.655 4.398 1.905 6.166l-1.138 4.162 4.273-1.12z"/>
    </svg>
);

export const MessengerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 2C6.48 2 2 6.48 2 12c0 3.54 1.84 6.64 4.57 8.43.08.04.16.08.24.12.1.04.2.09.3.13.24.1.48.2.73.29.28.1.57.18.87.25.12.03.24.06.37.08.3.06.6.1.9.14.2.02.4.04.6.05.28.01.56.02.84.02s.56-.01.84-.02c.2-.01.4-.03.6-.05.3-.04.6-.08.9-.14.13-.02.25-.05.37-.08.3-.07.59-.15.87-.25.25-.09.49-.19.73-.29.1-.04.2-.09.3-.13.08-.04.16-.08.24-.12C20.16 18.64 22 15.54 22 12c0-5.52-4.48-10-10-10zm-2.43 12.37l-1.4-1.4 2.83-2.83-2.83-2.83 1.4-1.4 2.83 2.83 2.83-2.83 1.4 1.4-2.83 2.83 2.83 2.83-1.4 1.4-2.83-2.83-2.83 2.83z"/>
    </svg>
);
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c1.356 0 2.673-.174 3.946-.512M12 3c-1.356 0-2.673.174-3.946.512M3.284 8.251a9.004 9.004 0 0 1 17.432 0M3.284 15.749a9.004 9.004 0 0 0 17.432 0M12 3v18" />
    </svg>
);
...
export const FireIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.048 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0-4.242 5.624" />
    </svg>
);
...
export const BellIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.31 5.771 23.848 23.848 0 0 0 5.454 1.31M15 17.5v-.5a3 3 0 0 0-6 0v.5a3 3 0 0 0 6 0Z" />
    </svg>
);
