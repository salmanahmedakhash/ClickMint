...
const faqData = [
    ...
    {
        question: "সাইট ভিজিট করলেই কি টাকা নিশ্চিত?",
        answer: "হ্যাঁ, তবে শুধুমাত্র নির্দিষ্ট সময় অপেক্ষা করলে এবং আমাদের সততার শর্তাবলী না ভাঙলে রিওয়ার্ড নিশ্চিতভাবে আপনার অ্যাকাউন্টে যোগ হবে।"
    },
    {
